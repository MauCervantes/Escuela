...
namespace AplicacionDatos.Context;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=Mau;Database=escuela;Trust Server Certificate=true;User Id=sa;Password=12345;MultipleActiveResultSets=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FCE558ABE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FC6A3BC41");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F557E67FA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83FF5A69103");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7BD323BE5");
